...
const EXACT_ES: Record<string, string> = {
  ...
  "The password cannot be based on your email address.": "La contraseña no puede basarse en tu email.",
  "The password cannot be based on your name.": "La contraseña no puede basarse en tu nombre.",
  "This account was deleted.": "Esta cuenta fue eliminada.",
  "Type the email of your account to confirm.": "Escribe el email de tu cuenta para confirmar.",
  "Your subscription could not be cancelled right now. Try again later.": "No pudimos cancelar tu suscripción ahora. Inténtalo más tarde.",
