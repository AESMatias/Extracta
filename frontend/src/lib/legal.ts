    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "The PDF file is deleted from our servers right after processing. Extracted data is stored only if you choose to save it to your history, until you delete it or close your account. We do not use your documents to train AI models. Make sure you have the rights to every document you upload.",
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "El archivo PDF se borra de nuestros servidores apenas se procesa. Los datos extraídos se guardan solo si eliges guardarlos en tu historial, hasta que los borres o cierres tu cuenta. No usamos tus documentos para entrenar modelos de IA. Asegúrate de tener los derechos sobre cada documento que subas.",
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Your documents: the PDFs you upload, deleted right after processing, and the data extracted from them. In process-only mode that data is kept for 1 hour and never written to a database; it is stored only if you choose to save it to your history.",
      ...
      },
      {
        ...
        paragraphs: [],
        bullets: [
          "PDF files: deleted right after processing; any left behind by an error are removed within hours.",
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Tus documentos: los PDFs que subes, que se borran apenas se procesan, y los datos extraídos de ellos. En modo solo procesar esos datos se conservan 1 hora y nunca se escriben en una base de datos; solo se guardan si eliges guardarlos en tu historial.",
      ...
      },
      {
        ...
        paragraphs: [],
        bullets: [
          "Archivos PDF: se borran apenas se procesan; los que quedan por un error se eliminan en pocas horas.",
