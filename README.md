...
- **Uploads**: streamed to disk in 64 KB chunks, their format recognised from the first bytes
  (never the file name), stored under server-generated names, deleted after processing; a
